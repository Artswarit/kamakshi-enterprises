...
export function CtaBanner({ onRequestQuote }: { onRequestQuote: () => void }) {
  return (
        ...
        <div className="relative overflow-hidden rounded-2xl gradient-fire p-10 md:p-16 text-white shadow-elegant">
          ...
          <div className="relative grid md:grid-cols-[1.5fr_auto] items-center gap-8">
            <div>
              ...
              <p className="mt-3 text-white/90 text-lg max-w-2xl">Share your requirements: our sales team responds within 4 working hours with a custom quote, samples and a compliance checklist.</p>
            </div>
            <div className="flex flex-col sm:flex-row md:flex-col gap-3">
              ...
              <Button
                size="lg"
                variant="outline"
                className="bg-transparent border-white/40 text-white hover:bg-white hover:text-primary h-12 px-6"
                onClick={onRequestQuote}
              >
